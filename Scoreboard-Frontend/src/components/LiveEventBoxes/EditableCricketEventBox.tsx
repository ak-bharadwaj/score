        ...
        <div className="liveEventBox cricket">
            ...
            <div className="cricket-team-row-compact">
                ...
                <div className="mini-score-grid">
                    <div className="input-with-label-mini">
                        ...
                        <input type="number" className="styledInput" value={score?.teamA_runs || 0} onChange={(e) => updateLocalScore("teamA_runs", Number(e.target.value))} />
                    </div>
                    <div className="input-with-label-mini">
                        <span className="mini-label">WKT</span>
                        <input type="number" className="styledInput" value={score?.teamA_wickets || 0} onChange={(e) => updateLocalScore("teamA_wickets", Number(e.target.value))} />
                    </div>
                    <div className="input-with-label-mini">
                        <span className="mini-label">OVR</span>
                        <input type="number" className="styledInput" step="0.1" value={score?.teamA_overs || 0} onChange={(e) => updateLocalScore("teamA_overs", Number(e.target.value))} />
                    </div>
                </div>
            </div>
            ...
            <div className="cricket-team-row-compact" style={{ marginTop: '10px' }}>
                ...
                <div className="mini-score-grid">
                    <div className="input-with-label-mini">
                        <span className="mini-label">RUNS</span>
                        <input type="number" className="styledInput" value={score?.teamB_runs || 0} onChange={(e) => updateLocalScore("teamB_runs", Number(e.target.value))} />
                    </div>
                    <div className="input-with-label-mini">
                        <span className="mini-label">WKT</span>
                        <input type="number" className="styledInput" value={score?.teamB_wickets || 0} onChange={(e) => updateLocalScore("teamB_wickets", Number(e.target.value))} />
                    </div>
                    <div className="input-with-label-mini">
                        <span className="mini-label">OVR</span>
                        <input type="number" className="styledInput" step="0.1" value={score?.teamB_overs || 0} onChange={(e) => updateLocalScore("teamB_overs", Number(e.target.value))} />
                    </div>
                </div>
            </div>
        </div>
